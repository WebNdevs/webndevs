...
class UpdateArticlePageRequest extends FormRequest
{
    ...
    {
        $articlePageId = $this->route('articlePage')?->id;

        return [
            'title' => ['sometimes', 'required', 'string', 'max:255'],
            'slug' => ['sometimes', 'required', 'string', 'max:255', Rule::unique('article_pages', 'slug')->ignore($articlePageId)],
