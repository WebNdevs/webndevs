...
class UpdateSinglePagePageRequest extends FormRequest
{
    ...
    {
        $singlepagePageId = $this->route('singlepagePage')?->id;

        return [
            'title' => ['sometimes', 'required', 'string', 'max:255'],
            'slug' => ['sometimes', 'required', 'string', 'max:255', Rule::unique('singlepage_pages', 'slug')->ignore($singlepagePageId)],
