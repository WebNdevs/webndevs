...
class DataHubPageSeeder extends Seeder
{
    ...
    {
        // 1. Create Home page
        $homePage = DataHubPage::query()->updateOrCreate(
            ['slug' => '/tools'],
            [
                'title' => 'Tools',
                'slug' => '/tools',
        ...
        $datahubPage = DataHubPage::query()->updateOrCreate(
            ['slug' => '/free-tools'],
            [
                'title' => 'Free Tools',
                'slug' => '/free-tools',
    ...
    private function seedPageSections(int $pageId, string $heroTag, string $heroTitle, string $heroDesc): void
    {
        ...
        $this->createSection($pageId, 'header', 'header', [
            ...
            'subheading2' => 'Of Expert DataHubs',
    ...
    private function createSection(int $pageId, string $sectionKey, string $sectionType, array $data): DataHubSection
    {
