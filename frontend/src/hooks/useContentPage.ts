...
// // Section types
// export type SectionType = "heading-text" | "approach-table";
...
// export function getQaItems(section: ContentSection): ContentItem[] {
//   return section.items.filter(item => item.question !== undefined || item.answer !== undefined);
// }

// export function getProjectItems(section: ContentSection): ContentItem[] {
//   return section.items.filter(item => item.pro_name !== undefined);
// }

// export function getTestimonialItems(section: ContentSection): ContentItem[] {
//   return section.items.filter(item => item.test_name !== undefined);
// }

// export function getDataTileItems(section: ContentSection): ContentItem[] {
//   return section.items.filter(item => item.tile_name !== undefined);
// }

// export function getServiceCardItems(section: ContentSection): ContentItem[] {
//   return section.items.filter(item => item.ser_name !== undefined);
// }

// export function getChooseCardItems(section: ContentSection): ContentItem[] {
//   return section.items.filter(item => item.cc_name !== undefined);
// }

// export function getProcessCardItems(section: ContentSection): ContentItem[] {
//   return section.items.filter(item => item.pc_name !== undefined);
// }

// export function getActiveItems(section: ContentSection): ContentItem[] {
