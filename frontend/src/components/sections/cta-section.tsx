...
export function CTASection() {
  return (
    <section id="get-started" aria-label="Contact and consultation request" className="py-16 mt-16 px-4 sm:px-6 bg-[#111827]/40 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Content */}
          <ScrollReveal direction="right" duration={0.8} className="w-full">
            <div>
          ...
          {/* Right Content */}
          <ScrollReveal direction="left" duration={0.8} delay={0.1} className="w-full max-w-xl mx-auto lg:max-w-none">
            <div>
              <CTAForm/>
            </div>
          </ScrollReveal>
