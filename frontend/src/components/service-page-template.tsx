...
export function ServicePageTemplate({ data, serviceSlug, onBackHome, initialSyncToken = null, plans = EMPTY_SERVICE_PLANS }: ServicePageTemplateProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F14]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {data.stats.map((stat, index) => (
                <div key={index} className="text-center">
                  <p style={{ fontSize: '32px' }} className="font-bold bg-linear-to-r from-[#22C55E] to-[#06B6D4] bg-clip-text text-transparent mb-2">
                    {stat.value}
                  </p>
      ...
      {/* SERVICE PACKAGE,COMPARISON,CALCULATOR */}
      {activePlans.length > 0 && (
        <>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="p-8 md:p-10 bg-[#111827] border border-[#334155]/40 rounded-none">
            ...
            <div className="relative">
              <div className="hidden lg:block absolute left-[50%] top-0 bottom-0 w-0.5 bg-linear-to-b from-[#22C55E] to-[#06B6D4]" />
            ...
            {frontendFaq.map((item, index) => (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <button className="shrink-0 text-[#22C55E]">
                    <ChevronDown 
      ...
      <section id="service-contact" className="py-20 px-6 bg-[#0B0F14] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <DSCard className="bg-linear-to-br from-[#22C55E]/5 to-[#06B6D4]/5 border-2 border-[#22C55E]/30 text-center">
            <h2 style={{ fontSize: '42px' }} className="font-bold text-[#F9FAFB] mb-4">
