 ...
 * - LinkedIn Ads
 * 
 * Focus: Single service conversion (Web Development)
 * Can be duplicated and customized for other services
 */
    ...
    <div style={{ fontFamily: 'Inter, sans-serif' }} className="min-h-screen bg-[#0B0F14]">
      ...
      <nav className="py-6 px-6 border-b border-[#374151]">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#22C55E] to-[#06B6D4] flex items-center justify-center">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <DSCard hover className="text-center">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-[#22C55E]/10 to-[#06B6D4]/10 border border-[#22C55E]/20 flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <DSCard className="bg-gradient-to-br from-[#22C55E]/5 to-[#06B6D4]/5 border-2 border-[#22C55E]/30">
